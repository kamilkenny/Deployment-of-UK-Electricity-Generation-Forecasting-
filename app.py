...
st.markdown("""
    ...
    /* ENLARGED: Centering the Lead Modeller Architecture Image */
    .main-img-container {
        display: flex;
    ...
    .responsive-img {
        width: 85%; /* Increased from 350px to 85% of container width */
        max-width: 1100px;
        height: auto;
        border-radius: 10px;
...
# 3. Central Image & Header (SHARPNESS & SIZE FIX)
    ...
    st.markdown(
        ...
        <div class="main-img-container">
            ...
            <p style="margin-top: 15px; font-size: 1.1em; font-weight: bold; color: black;">
                Kamil Kehinde - Lead Modeller | System Architecture & Forecasting Logic
            </p>
        </div>
        """,
        unsafe_allow_html=True
