...
# 3. Central Image & Header (SHARPNESS FIX)
...
try:
    ...
    st.markdown(
        ...
        <div class="main-img-container">
            <img src="data:image/png;base64,{img_b64}" width="350" style="border-radius: 10px; box-shadow: 0px 4px 10px rgba(0,0,0,0.1);">
            <p style="margin-top: 10px; font-weight: bold; color: black;">Kamil Kehinde - Lead Modeller</p>
        </div>
        """,
        unsafe_allow_html=True
    )
...
predict_btn = st.button("🚀 Run Generation Forecast Analysis", type="primary", use_container_width=True)
...
if predict_btn:
    if isinstance(selected_range, tuple) and len(selected_range) == 2:
        ...
        st.download_button("📥 Download Analysis Results (CSV)", df_pred.to_csv(), "forecast_results.csv", "text/csv")
    else:
